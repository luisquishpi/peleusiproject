...
public class CompraRetencionFrm extends javax.swing.JDialog {
	...
	private void cargarCodigoRetencion() {
		// Integer.parseInt(cmbTipoRetencion.getSelectedItem().toString())
		TipoRetencionController tipoRetencionController = new TipoRetencionController();
		List<TipoRetencion> listaTipoRetencion;
		System.out.println("uno");
		TipoRetencionEnum tipoRetencionEnum = (TipoRetencionEnum) cmbTipoRetencion.getSelectedItem();
		listaTipoRetencion = tipoRetencionController.tipoRetencionTipoList(tipoRetencionEnum);
		System.out.println("dos" + listaTipoRetencion);
		cmbCodigoRetencion.setModel(new DefaultComboBoxModel(listaTipoRetencion.toArray()));
	}
	...
	public void crearControles() {
		...
		cmbCodigoRetencion = new JComboBox<TipoRetencion>();
