...
public class TarifaIvaCruFrm extends JInternalFrame {
	...
	private JFormattedTextField txtPorcentaje_1;
	int limitecaja = 15;
	...
	private void crearControles() {
		...
		JFormattedTextField txtPorcentaje = new JFormattedTextField();
		txtPorcentaje.setBounds(133, 112, 59, 20);
		txtPorcentaje_1 = new JFormattedTextField();
		txtPorcentaje_1.setToolTipText("");
		txtPorcentaje_1.setSize(75, 20);
		txtPorcentaje_1.setLocation(134, 109);
		txtPorcentaje_1.setFormatterFactory(new Formatos().getDecimalFormat());
		panelCuerpo.add(txtPorcentaje_1);
	}
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TarifaIva tarifaIva = new TarifaIva(txtCodigo.getText(), txtNombre.getText(),
						Double.parseDouble(txtPorcentaje_1.getText()));
	...
	private void limpiarCampos() {
		txtCodigo.setText("");
		txtNombre.setText("");
		txtPorcentaje_1.setText("0");
	}

	private boolean isCamposLlenos() {
		boolean llenos = true;
		if (txtCodigo.getText().isEmpty() || txtNombre.getText().isEmpty() || txtPorcentaje_1.getText().isEmpty())
			llenos = false;
		return llenos;
	}
}
