...
import ec.peleusi.views.fx.controllers.CiudadListModalController;
...
public class CiudadListModalMain extends Application {
	...
	public void start(Stage stage) throws IOException {
		...
		loader.setController(new CiudadListModalController());
