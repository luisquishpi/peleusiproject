...
import ec.peleusi.views.fx.controllers.ClienteListModalController;
...
public class ClienteListModalMain extends Application {
	...
	public void start(Stage stage) throws IOException {
		...
		loader.setController(new ClienteListModalController());
