...
import ec.peleusi.views.fx.controllers.TipoPagoListModalController;
...
public class TipoPagoListModalMain extends Application {
	private static Parent parent;
	
	@Override
	public void start(Stage stage) throws IOException {
		stage.setTitle("Lista de Tipo de Pago");

		FXMLLoader loader = new FXMLLoader(getClass().getResource("../designs/TipoPagoListModalFx.fxml"));
		loader.setController(new TipoPagoListModalController());
